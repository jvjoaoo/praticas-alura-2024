...
let valorFormatado = valorCompra.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'})

const setorUm = "Compras"
const setorDois = "Licitações"

if(valorCompra >= 64.000){
console.log(`Desculpe ${userName}, não podemos prosseguir com o seu atendimento o valor da sua compra excede o limite. Você foi direcionado ao setor de ${setorDois} para obter a ajuda necessária`)
} else {
